...
The storefront home page includes catalog filters so visitors can narrow the game list by category and publisher while keeping the static Astro experience fast and accessible.
